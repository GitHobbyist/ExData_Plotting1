plot3 <- function() {
        ...
        with(data, { 
                plot(Time,Sub_metering_1,type="l",col="gray60",xlab="",ylab = "Energy sub metering",cex.lab= 0.7,cex.axis=0.7,cex.main=0.8,
                     font.lab=2,font.axis=2,lwd=2)
                points(Time,Sub_metering_2,type="l",col="orangered2")
                points(Time,Sub_metering_3,type="l",col="blue")
                legend("topright",lwd=2 , col= c("gray60","orangered2","blue"), legend=lgdNames[c(7,8,9)],cex=0.7,pt.cex=2,text.font=2)
                mtext("Plot 3",side=3,outer=TRUE,adj=0,font=2,cex=0.8)
        })
